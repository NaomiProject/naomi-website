...
export default {
  ...
  created () {
    if (this.$site.base && this.$site.base.indexOf('v') > 0) {
      ...
      this.versionBranches = ['stable', this.currentBranch] // to avoid having to regenerate previous sites
    }
  },
  computed: {
    versions () {
...
export default {
  ...
  created () {
    if (this.$site.base && this.$site.base.indexOf('v') > 0) {
      ...
      this.versionNumbers = ['stable', this.currentVersion] // to avoid having to regenerate previous sites
    }
  },
  computed: {
    versions () {
