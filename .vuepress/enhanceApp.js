...
export default ({
    ...
    if (typeof window !== 'undefined') {
      ...
      tag.setAttribute('data-bg', '#000000')
      tag.setAttribute('data-fg', '#FFFFFF')
      tag.setAttribute('data-link', '#1086bc')
      ...
      tag.setAttribute('data-divlink', '#FFFFFF')
      tag.setAttribute('data-divlinkbg', '#1086bc')
